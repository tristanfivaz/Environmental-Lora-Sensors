...
const uint8_t spreading_factor = 7; // set this to the derired LoRa spreading factor
...
void getTemperature()
{
    ...
    f = dht.readTemperature(true);
                              ...
                              //Not too sure about this chunk of code- I just want to push the temp variable to lora but its not exactly defined which variable or process it uses.
    temp*=100;
    if (temp<0) {
        negativeFlag = 0x80;
    } else {
